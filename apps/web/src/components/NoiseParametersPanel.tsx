...
interface NoiseParametersPanelProps {
  ...
  loading?: boolean
  error?: string | null
  autoGenerate?: boolean // New prop: automatically call onGenerate when parameters change
  autoGenerateDelay?: number // Delay in ms before auto-generating (default: 500ms)
}
